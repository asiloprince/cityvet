  ...
  return (
    <div className=" mx-auto bg-white-100 p-4 rounded-md">
      <div className="flex justify-between">
        <h1 className="font-bold text-xl text-gray-600 ">Recent Activity</h1>
        <div className="flex mb-3">
          <button className="border-2 bg-[#fafaf9] text-[#9ca3af] text-sm rounded-md flex items-center justify-center mr-2 p-2">
            Filter <LiaFilterSolid size={14} />
          </button>
          <button className=" text-white  font-bold rounded-md p-2 text-sm  bg-cyan-600">
            View All
          </button>
        </div>
      </div>
