...
type DialogDescriptionDivProps = {
  className?: string;
};

const DialogDescriptionDiv: React.FC<DialogDescriptionDivProps> = ({
  className,
  ...props
}) => (
  <div
...
DialogDescriptionDiv.displayName = DialogPrimitive.Title.displayName;
export {
  Dialog,
