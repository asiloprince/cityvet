      ...
      <header className="flex justify-between items-center mt-10 ">
        ...
        <nav className="">
          <ul className="flex justify-end gap-16 p-4 ">
            <li>
              <button className=" bg-cyan-600  p-2 rounded-lg flex font-bold text-white">
                <BsPlusLg size={20} className=" " /> Create
              </button>
            </li>
            <li>
              <button className="text-center hover:text-cyan-600">
        ...
        <div className="col-span-2 shadow-md m-4 rounded-lg">
          ...
          <div className="m-5 text-sm ">
            ...
            <ul className="flex justify-between mt-2">
              <li className="bg-green-300 p-1 rounded-md text-white font-bold">
                Libjo, Batangas City
              </li>
              <li className="bg-green-300 p-1 rounded-md text-white font-bold">
                09*********
